  ...
  return (
    <div>
      ...
      <div className='flex gap-4 my-8'>
             {/*---Total Booings---*/}
             <div className='bg-[#2563EB3] border border-[#2563EB10] rounded flex p-4 pr-8'>
                     <img src={assets.totalBookingIcon} alt="TotalBooking-icon" className='max-sm:hidden h-10'></img>
                     <div className='flex flex-col sm:ml-4 font-medium'>
                        <p className='text-blue-500 text-lg'>Total Bookings</p>
                        <p className='text-neutral-400 text-base'>{dash.totalBookings}</p>
                     </div>
             </div>
             {/*---Total revenue---*/}
              <div className='bg-[#2563EB3] border border-[#2563EB10] rounded flex p-4 pr-8'>
                     <img src={assets.totalRevenueIcon} alt="TotalBooking-icon" className='max-sm:hidden h-10'></img>
                     <div className='flex flex-col sm:ml-4 font-medium'>
                        <p className='text-blue-500 text-lg'>Total Revenue</p>
                        <p className='text-neutral-400 text-base'>{currency} {dash.totalRevenue}</p>
                     </div>
             </div>
      </div>
      {/*Recent Bookings*/}
